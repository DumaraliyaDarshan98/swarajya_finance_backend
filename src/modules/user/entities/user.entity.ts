...
export class User {
  ...
  @Column({ name: 'employee_type', type: 'varchar', length: 100, nullable: true })
  employeeType: string | null;

  @Column({ name: 'mobile_number', type: 'varchar', length: 20, nullable: true })
  mobileNumber: string | null;

  @Column({ name: 'alternate_number', type: 'varchar', length: 20, nullable: true })
  ...
  // --- Address Details ---
  @Column({ name: 'flat_plot_no', type: 'varchar', length: 255, nullable: true })
  ...
  @Column({ name: 'cancelled_cheque_url', type: 'varchar', length: 500, nullable: true })
  cancelledChequeUrl: string | null;

  @Column({ name: 'cancelled_cheque_url_2', type: 'varchar', length: 500, nullable: true })
  cancelledChequeUrl2: string | null;

  @Column({ name: 'offer_letter_url', type: 'varchar', length: 500, nullable: true })
  offerLetterUrl: string | null;

  @Column({ name: 'marksheet_12_url', type: 'varchar', length: 500, nullable: true })
  marksheet12Url: string | null;

  @Column({ name: 'graduation_marksheet_url', type: 'varchar', length: 500, nullable: true })
  graduationMarksheetUrl: string | null;

  @Column({ name: 'post_graduate_cert_url', type: 'varchar', length: 500, nullable: true })
  postGraduateCertUrl: string | null;

  @Column({ name: 'additional_cert_url', type: 'varchar', length: 500, nullable: true })
